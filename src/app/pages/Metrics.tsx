  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="text-gray-400">DORA metrics, token usage, and performance analytics</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
          ...
          <h3 className="text-3xl font-bold text-white mb-1">2.5/week</h3>
        ...
        <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
          ...
          <h3 className="text-3xl font-bold text-white mb-1">45 mins</h3>
        ...
        <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
          ...
          <h3 className="text-3xl font-bold text-white mb-1">2.4 days</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
          <h2 className="text-xl font-semibold text-white mb-6">Deployment Frequency</h2>
        ...
        {/* Token Cost Trend */}
        <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
          <h2 className="text-xl font-semibold text-white mb-6">Token Cost Trend</h2>
          <ResponsiveContainer width="100%" height={250}>
      ...
      {/* Governance Heatmap */}
      <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
        <h2 className="text-xl font-semibold text-white mb-6">Governance Heatmap</h2>
      ...
      {/* Live Token Usage */}
      <div className="bg-[#111827] border border-white/10 rounded-xl p-6">
        <h2 className="text-xl font-semibold text-white mb-6">Live Token Usage by Agent</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-white/5 rounded-lg">
            <p className="text-sm text-gray-400 mb-3">development_agent</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-400">Input:</span>
                <span className="text-white font-medium">12k tokens</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Output:</span>
                <span className="text-white font-medium">6k tokens</span>
              </div>
          ...
          <div className="p-4 bg-white/5 rounded-lg">
            <p className="text-sm text-gray-400 mb-3">security_agent</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-400">Input:</span>
                <span className="text-white font-medium">8k tokens</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Output:</span>
                <span className="text-white font-medium">3k tokens</span>
              </div>
              <div className="flex justify-between pt-2 border-t border-white/10">
                <span className="text-gray-400">Cost:</span>
          ...
          <div className="p-4 bg-white/5 rounded-lg">
            <p className="text-sm text-gray-400 mb-3">testing_agent</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-400">Input:</span>
                <span className="text-white font-medium">15k tokens</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Output:</span>
                <span className="text-white font-medium">9k tokens</span>
              </div>
              <div className="flex justify-between pt-2 border-t border-white/10">
                <span className="text-gray-400">Cost:</span>
