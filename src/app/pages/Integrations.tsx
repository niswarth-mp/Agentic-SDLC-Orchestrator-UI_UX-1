  ...
  return (
    <div className="p-8 space-y-8 bg-gray-50 dark:bg-[#0A0F1E] transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {integrations.map((integration) => (
            ...
            >
              ...
              {integration.status === "connected" ? (
                <button className="w-full px-4 py-2 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-lg transition-all flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-gray-50 dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#6366F1]"
              >
                <option value="deployment.completed">
                  deployment.completed
                </option>
                <option value="deployment.failed">deployment.failed</option>
                <option value="security.vulnerability_detected">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-50 dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#6366F1]"
              />
            </div>
          </div>
      ...
      <div>
        ...
        <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-xl overflow-hidden">
