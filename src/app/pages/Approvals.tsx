import { CheckCircle, XCircle, Clock, Shield, TestTube, DollarSign, AlertTriangle } from 'lucide-react';
import { useState } from 'react';

type ApprovalCategory = 'all' | 'design' | 'qa' | 'merge' | 'infrastructure' | 'compliance';
...
export function Approvals() {
  ...
  const categories = [
    ...
    { id: 'design' as ApprovalCategory, label: 'Design Reviews', count: approvals.filter(a => a.category === 'design').length },
    { id: 'qa' as ApprovalCategory, label: 'QA Gates', count: approvals.filter(a => a.category === 'qa').length },
    { id: 'merge' as ApprovalCategory, label: 'Merge Reviews', count: approvals.filter(a => a.category === 'merge').length },
    { id: 'infrastructure' as ApprovalCategory, label: 'Infrastructure', count: approvals.filter(a => a.category === 'infrastructure').length },
    { id: 'compliance' as ApprovalCategory, label: 'Compliance', count: approvals.filter(a => a.category === 'compliance').length },
  ];
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Review and approve pending changes</p>
        </div>
      ...
      <div className="space-y-4">
        {filteredApprovals.map((approval) => (
          <div
            key={approval.id}
            className={`bg-[#111827] border rounded-xl p-6 hover:border-[#6366F1]/50 transition-all ${
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h3 className="text-xl font-semibold text-white">{approval.project}</h3>
                  {approval.urgency === 'critical' && (
                ...
                <div className="flex items-center gap-4 text-sm text-gray-400">
                  <span>Reviewer: <span className="text-white">{approval.reviewer}</span></span>
                  <span>•</span>
                  <div className="flex items-center gap-2">
              ...
              <div className="text-right">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xl font-bold text-white">{approval.confidence}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6 p-4 bg-white/5 rounded-lg">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">{approval.gateSummary.coverage}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">
                    {approval.gateSummary.tests.passed}/{approval.gateSummary.tests.total}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">{approval.gateSummary.infraCost}</p>
                </div>
              </div>
