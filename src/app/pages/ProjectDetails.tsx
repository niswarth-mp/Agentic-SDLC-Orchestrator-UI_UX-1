...
import { Activity, Package, CheckCircle, BarChart3, FileText } from 'lucide-react';
...
export function ProjectDetails() {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="bg-[#111827] border-b border-white/10 p-6">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white mb-3">Project: {id}</h1>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left: SDLC Timeline */}
        <div className="w-64 bg-[#111827] border-r border-white/10 overflow-y-auto">
          <div className="p-4 border-b border-white/10">
            <h2 className="text-sm font-semibold text-white">SDLC Timeline</h2>
          </div>
          ...
          <div className="flex-1 overflow-hidden bg-[#0A0F1E]">
            ...
            {activeTab === 'logs' && (
              <div className="h-full p-6">
                ...
                <div className="bg-[#111827] border border-white/10 rounded-lg p-4 font-mono text-sm space-y-1 overflow-y-auto max-h-[500px]">
                  <div className="text-gray-400">[2024-05-19 10:22:15] development_agent: Starting test generation...</div>
                  <div className="text-gray-400">[2024-05-19 10:22:18] development_agent: Generated 12 unit tests</div>
                  <div className="text-[#F59E0B]">[2024-05-19 10:21:45] security_agent: WARNING - JWT vulnerability detected</div>
                  <div className="text-gray-400">[2024-05-19 10:21:50] security_agent: Running security scan...</div>
                  <div className="text-[#22C55E]">[2024-05-19 10:20:30] testing_agent: Coverage increased to 91%</div>
                </div>
              </div>
            )}
            {activeTab === 'approvals' && (
              <div className="h-full p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-[#111827] border border-white/10 rounded-lg p-4">
                    <h4 className="text-white font-medium mb-2">Design Approval</h4>
                    <p className="text-sm text-gray-400 mb-3">Reviewer: Alice • Confidence: 88%</p>
            ...
            {activeTab === 'audit' && (
              <div className="h-full p-6">
                ...
                <div className="space-y-2">
                  <div className="bg-[#111827] border border-white/10 rounded-lg p-4">
                    <p className="text-sm text-gray-400">2024-05-19 10:22 • development_agent modified PaymentService.java</p>
                  </div>
                  <div className="bg-[#111827] border border-white/10 rounded-lg p-4">
                    <p className="text-sm text-gray-400">2024-05-19 10:21 • security_agent flagged vulnerability CVE-2024-1234</p>
                  </div>
                </div>
              </div>
            )}
        ...
        {/* Right: AI Copilot */}
        <div className="w-96 bg-[#111827] border-l border-white/10">
          <AICopilot />
        </div>
      </div>
    </div>
