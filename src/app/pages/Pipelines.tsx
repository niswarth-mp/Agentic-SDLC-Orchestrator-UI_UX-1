...
export function Pipelines() {
  const pipelines = [
    ...
    },
    {
      ...
      progress: 42,
      currentPhase: "Deploy",
      agents: [{ name: "deployment_agent", status: "failed", progress: 42 }],
      startedAt: "08:00 AM",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Real-time orchestration and agent execution
          </p>
        </div>
        <div className="flex gap-2">
          <button className="px-4 py-2 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-lg transition-all">
            View History
          </button>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {pipelines.map((pipeline) => (
          ...
          >
            ...
            {/* Timeline Info */}
            <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-white/10 text-sm">
