  ...
  const agentActivity = [
    {
      time: "10:22",
      agent: "testing_agent",
      message: "coverage increased to 91%",
      type: "success",
    },
    {
      time: "10:21",
      agent: "security_agent",
      message: "detected CVE-2024-1234",
      type: "warning",
    },
    {
      time: "10:20",
    ...
    },
    {
      ...
      message: "rolling out to staging",
      type: "info",
    },
  ];
    ...
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Command center for engineering leadership
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Pipeline Health */}
        <div className="lg:col-span-2 bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-xl p-6 transition-colors">
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center border-2 ${
                      stage.status === "completed"
                        ...
                        : stage.status === "active"
                          ...
                          : "bg-transparent border-gray-300 dark:border-white/20 text-gray-400 dark:text-white/40"
                    }`}
                  >
                    {stage.status === "completed" ? (
        ...
        {/* DORA Metrics */}
        <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-xl p-6 transition-colors">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
            DORA Metrics
          </h2>
        ...
        <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/10 rounded-xl p-6 transition-colors">
          ...
          <div className="space-y-3">
            {agentActivity.map((activity, index) => (
              <div
                key={index}
                className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-white/5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 transition-all"
              >
